...
UmlPackage * UmlBasePackage::findNamespace(const QByteArray & n) const {
...
UmlPackage * UmlBasePackage::findPackage(const QByteArray & n) const {
...
UmlPackage * UmlBasePackage::findModule(const QByteArray & n) const {
