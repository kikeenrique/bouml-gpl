...
class UmlBasePackage : public UmlItem {
  public:
    ...
    UmlPackage * findCppNamespace(const QByteArray & n) const;
#endif
    ...
    // (including the current one), else 0/null
    UmlPackage * findJavaPackage(const QByteArray & n) const;
#endif
    ...
    // (including the current one), else 0/null
    UmlPackage * findPythonPackage(const QByteArray & n) const;
#endif
    ...
    // (including the current one), else 0/null
    UmlPackage * findIdlModule(const QByteArray & n) const;
#endif
