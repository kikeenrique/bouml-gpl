...
**
** Created: Sat Apr 5 23:54:44 2014
...
QMetaObject* Dialog::staticMetaObject()
{
    ...
    static const QUMethod slot_2 = {"accept_cpp", 0, 0 };
    static const QUMethod slot_3 = {"accept_uml", 0, 0 };
    static const QUMethod slot_4 = {"accept_java", 0, 0 };
    static const QUMethod slot_5 = {"accept", 0, 0 };
    static const QMetaData slot_tbl[] = {
	{ "polish()", &slot_0, QMetaData::Protected },
	{ "browse()", &slot_1, QMetaData::Protected },
	{ "accept_cpp()", &slot_2, QMetaData::Protected },
	{ "accept_uml()", &slot_3, QMetaData::Protected },
	{ "accept_java()", &slot_4, QMetaData::Protected },
	{ "accept()", &slot_5, QMetaData::Protected }
    };
...
bool Dialog::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 0: polish(); break;
    case 1: browse(); break;
    case 2: accept_cpp(); break;
    case 3: accept_uml(); break;
    case 4: accept_java(); break;
    case 5: accept(); break;
    default:
