...
**
** Created: Sat Apr 5 23:51:44 2014
...
QMetaObject* Dialog::staticMetaObject()
{
    ...
    static const QUMethod slot_2 = {"browse_pro", 0, 0 };
    static const QUMethod slot_3 = {"browse_target", 0, 0 };
    static const QUMethod slot_4 = {"compute_includepath", 0, 0 };
    static const QUMethod slot_5 = {"browse_objectsdir", 0, 0 };
    static const QMetaData slot_tbl[] = {
	{ "polish()", &slot_0, QMetaData::Protected },
	{ "accept()", &slot_1, QMetaData::Protected },
	{ "browse_pro()", &slot_2, QMetaData::Protected },
	{ "browse_target()", &slot_3, QMetaData::Protected },
	{ "compute_includepath()", &slot_4, QMetaData::Protected },
	{ "browse_objectsdir()", &slot_5, QMetaData::Protected }
    };
...
bool Dialog::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 0: polish(); break;
    case 1: accept(); break;
    case 2: browse_pro(); break;
    case 3: browse_target(); break;
    case 4: compute_includepath(); break;
    case 5: browse_objectsdir(); break;
    default:
