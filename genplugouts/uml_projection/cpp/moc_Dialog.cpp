...
**
** Created: Sat Apr 5 23:58:08 2014
...
QMetaObject* Dialog::staticMetaObject()
{
    ...
    static const QUMethod slot_2 = {"accept_java", 0, 0 };
    static const QUMethod slot_3 = {"accept_idl", 0, 0 };
    static const QUMethod slot_4 = {"accept_php", 0, 0 };
    static const QUMethod slot_5 = {"accept_python", 0, 0 };
    static const QUMethod slot_6 = {"accept", 0, 0 };
    static const QMetaData slot_tbl[] = {
	{ "polish()", &slot_0, QMetaData::Protected },
	{ "accept_cpp()", &slot_1, QMetaData::Protected },
	{ "accept_java()", &slot_2, QMetaData::Protected },
	{ "accept_idl()", &slot_3, QMetaData::Protected },
	{ "accept_php()", &slot_4, QMetaData::Protected },
	{ "accept_python()", &slot_5, QMetaData::Protected },
...
bool Dialog::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 2: accept_java(); break;
    case 3: accept_idl(); break;
    case 4: accept_php(); break;
    case 5: accept_python(); break;
    case 6: accept(); break;
    default:
