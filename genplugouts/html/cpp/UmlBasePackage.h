...
class UmlBasePackage : public UmlItem {
  public:
    ...
    static UmlPackage * findNamespace(const QCString & n, const UmlBasePackage * p = 0);
#endif
    ...
    // (including 'p' itself), else 0
    static UmlPackage * findPackage(const QCString & n, const UmlBasePackage * p = 0);
#endif
    ...
    // (including 'p' itself), else 0
    static UmlPackage * findModule(const QCString & n, const UmlBasePackage * p = 0);
#endif
