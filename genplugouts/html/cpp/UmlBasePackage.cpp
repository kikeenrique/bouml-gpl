...
UmlPackage * UmlBasePackage::findCppNamespace(const QByteArray & n, const UmlBasePackage * p)
{
...
UmlPackage * UmlBasePackage::findJavaPackage(const QByteArray & n, const UmlBasePackage * p)
{
...
UmlPackage * UmlBasePackage::findPythonPackage(const QByteArray & n, const UmlBasePackage * p)
{
...
UmlPackage * UmlBasePackage::findIdlModule(const QByteArray & n, const UmlBasePackage * p)
{
