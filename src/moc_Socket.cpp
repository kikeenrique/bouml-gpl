...
const QMetaObjectExtraData Socket::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Socket::staticMetaObject = {
    { &Q3SocketDevice::staticMetaObject, qt_meta_stringdata_Socket,
      qt_meta_data_Socket, &staticMetaObjectExtraData }
};
...
void *Socket::qt_metacast(const char *_clname)
{
    ...
    return Q3SocketDevice::qt_metacast(_clname);
}

int Socket::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = Q3SocketDevice::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
