...
class UmlBaseInitialActivityNode : public UmlActivityControlNode {
  ...
  protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
     UmlBaseInitialActivityNode(void * id, const QByteArray & s) : UmlActivityControlNode(id, s) {
    }
...
class UmlBaseFlowFinalActivityNode : public UmlActivityControlNode {
  ...
  protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
     UmlBaseFlowFinalActivityNode(void * id, const QByteArray & s) : UmlActivityControlNode(id, s) {
    }
...
class UmlBaseActivityFinalActivityNode : public UmlActivityControlNode {
  ...
  protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
     UmlBaseActivityFinalActivityNode(void * id, const QByteArray & s) : UmlActivityControlNode(id, s) {
    }
...
class UmlBaseDecisionActivityNode : public UmlActivityControlNode {
  ...
  protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
     UmlBaseDecisionActivityNode(void * id, const QByteArray & s) : UmlActivityControlNode(id, s) {
    }
...
class UmlBaseMergeActivityNode : public UmlActivityControlNode {
  ...
  protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
     UmlBaseMergeActivityNode(void * id, const QByteArray & s) : UmlActivityControlNode(id, s) {
    }
...
class UmlBaseForkActivityNode : public UmlActivityControlNode {
  ...
  protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
     UmlBaseForkActivityNode(void * id, const QByteArray & s) : UmlActivityControlNode(id, s) {
    }
...
class UmlBaseJoinActivityNode : public UmlActivityControlNode {
  ...
  protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
     UmlBaseJoinActivityNode(void * id, const QByteArray & s) : UmlActivityControlNode(id, s) {
    }
