...
QByteArray UmlArtifact::imports;

void UmlArtifact::generate_imports(QTextStream & f, QByteArray & made) {
...
void UmlArtifact::generate() {
  if (! managed) {
    ...
    const QByteArray filedef = pythonSource();
...
const QByteArray & UmlArtifact::all_imports()
{
  return imports;
}
