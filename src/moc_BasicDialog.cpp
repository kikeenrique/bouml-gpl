...
static const char qt_meta_stringdata_BasicDialog[] = {
    "BasicDialog\0\0polish()\0accept()\0"
    "edit_description()\0"
};
...
const QMetaObjectExtraData BasicDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject BasicDialog::staticMetaObject = {
    { &Q3TabDialog::staticMetaObject, qt_meta_stringdata_BasicDialog,
      qt_meta_data_BasicDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &BasicDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BasicDialog))
