/****************************************************************************
** PinDialog meta object code from reading C++ file 'PinDialog.h'
**
...
const char *PinDialog::className() const
{
    return "PinDialog";
}

QMetaObject *PinDialog::metaObj = 0;
static QMetaObjectCleanUp cleanUp_PinDialog( "PinDialog", &PinDialog::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString PinDialog::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "PinDialog", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString PinDialog::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "PinDialog", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* PinDialog::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
	...
	0, 0 );
    cleanUp_PinDialog.setMetaObject( metaObj );
    return metaObj;
}

void* PinDialog::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "PinDialog" ) )
	return this;
    return QTabDialog::qt_cast( clname );
}

bool PinDialog::qt_invoke( int _id, QUObject* _o )
{
...
bool PinDialog::qt_emit( int _id, QUObject* _o )
{
    return QTabDialog::qt_emit(_id,_o);
}
#ifndef QT_NO_PROPERTIES

bool PinDialog::qt_property( int id, int f, QVariant* v)
{
    return QTabDialog::qt_property( id, f, v);
}

bool PinDialog::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
