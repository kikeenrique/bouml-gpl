...
**
** Created: Sat Apr 5 23:49:48 2014
...
QMetaObject* BrowserView::staticMetaObject()
{
    ...
    static const QUMethod slot_0 = {"rightPressed", 1, param_slot_0 };
    static const QMetaData slot_tbl[] = {
	{ "rightPressed(QListViewItem*)", &slot_0, QMetaData::Protected }
    };
...
bool BrowserView::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 0: rightPressed((QListViewItem*)static_QUType_ptr.get(_o+1)); break;
    default:
