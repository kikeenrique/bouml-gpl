...
void OperationData::update_cpp_get_of(QString & decl, QString & def,
...
void OperationData::update_java_get_of(QString & def, const QString & attr_name,
				       QString attjava_decl, QString multiplicity)
{
  ...
  if (attr_name_spec.isEmpty())
    ...
    int index2;
    QString d = (const char *) GenerationSettings::java_default_oper_def();
...
void OperationData::update_php_get_of(QString & def, const QString & attr_name,
				      QString attphp_decl)
{
  ...
  if (attr_name_spec.isEmpty())
    ...
    QString d = (const char *) GenerationSettings::php_default_oper_def();
...
void OperationData::update_python_get_of(QString & def, const QString & attr_name,
					 QString attpython_decl, bool attis_class_member)
{
  ...
  if (attr_name_spec.isEmpty())
    ...
    QString d = (const char *) GenerationSettings::python_default_oper_def();
...
void OperationData::update_idl_get_of(QString & decl, QString attidl_decl,
				      QString multiplicity)
{
  ...
  if (attr_name_spec.isEmpty())
    ...
    QString d = (const char *) GenerationSettings::idl_default_oper_decl();
    int index2;
    QString mult;
...
static QString cpp_copy(const QString attr_full_name, const QString param_name,
			 QString multiplicity, const QString elt_type,
			 QString indent)
{
  ...
  QString s4 = attr_full_name.left(4);
  ...
  QString srank;
  QString close;
  QString src_prev = param_name;
  QString tgt_prev = attr_full_name;
  int rank = 0;
  ...
  do {
	...
	((index = multiplicity.find("]")) == -1))
      return "#error invalid multiplicity part \"" + QString(multiplicity) + "\"\n";

    QString n = "(" + multiplicity.mid(1, index - 1) + ")";
...
void OperationData::update_cpp_set_of(QString & decl, QString & def,
				      const QString & attr_name,
				      QString attcpp_decl, bool attis_const,
				      QString multiplicity) {
  remove_comments(attcpp_decl);
  ...
  if (attr_name_spec.isEmpty()) {
    ...
    QString d = (const char *) GenerationSettings::cpp_default_oper_decl();
	...
	if (has_multiplicity) {
	  ...
	  d.replace(index, 7,
		    cpp_copy(QString(attr_full_name), params[0].get_name(),
			     QString(multiplicity), QString(elt_type),
			     QString(indent)));
	}
	else {
	  if (d[index - 1] == '\n')
...
void OperationData::update_java_set_of(QString & def, const QString & attr_name,
				       QString attjava_decl, QString multiplicity)
{
  remove_comments(attjava_decl);
  attjava_decl = attjava_decl.stripWhiteSpace();
...
void OperationData::update_php_set_of(QString & def,
				       const QString & attr_name,
				       QString attphp_decl)
{
  remove_comments(attphp_decl);
...
void OperationData::update_python_set_of(QString & def,
					const QString & attr_name,
...
void OperationData::update_idl_set_of(QString & decl, QString attidl_decl,
				      QString multiplicity)
{
  remove_comments(attidl_decl);
  attidl_decl = attidl_decl.stripWhiteSpace();
