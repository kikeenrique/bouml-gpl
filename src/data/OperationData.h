...
class OperationData : public ClassMemberData,
  ...
  public:
    ...
    static void update_cpp_get_of(QString & decl, QString & def,
				  const QString & attr_name,
				  QString attcpp_decl, bool attis_const,
				  QString multiplicity);
    static void update_java_get_of(QString & def, const QString & attr_name,
				   QString attjava_decl, QString multiplicity);
    static void update_php_get_of(QString & def, const QString & attr_name,
				  QString attphp_decl);
    static void update_python_get_of(QString & def, const QString & attr_name,
				     QString attpython_decl, bool attis_class_member);
    static void update_idl_get_of(QString & decl, QString attidl_decl,
				  QString multiplicity);
    void update_cpp_set_of(QString & decl, QString & def,
			   const QString & attr_name,
			   QString attcpp_decl, bool attis_const,
			   QString multiplicity);
    static void update_java_set_of(QString & def, const QString & attr_name,
				   QString attjava_decl, QString multiplicity);
    static void update_php_set_of(QString & def,
				  const QString & attr_name,
				  QString attphp_decl);
    static void update_python_set_of(QString & def, const QString & attr_name,
				     QString attpython_decl, bool attis_class_member);
    static void update_idl_set_of(QString & decl, QString attidl_decl,
				  QString multiplicity);
